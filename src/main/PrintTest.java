    ...
    public void paint(Graphics g) {
        ...
        for (String key : coords.keySet()) {
            ...
            if (state.get(0).get(0).size() != 2) {
                ...
                for (int i = 0; i < state4.get(0).size(); i++) {
                    int[] fillPolygon = new int[state4.get(0).get(i).size()];
                    int[] ints = new int[state4.get(0).get(0).size()];
                    for (int j = 0; j < state4.get(0).get(i).size(); j++){
                        fillPolygon[j] = (int) ((-state4.get(0).get(i).get(0).get(1) + 74.9) * 10.8);
                        ints[j] = (int) ((state4.get(0).get(i).get(0).get(0) + 180.0) * 10.8);
                    }
                    g.drawPolygon(ints, fillPolygon, ints.length);
                }
//                int[] fillPolygon = new int[state4.get(0).get(0).size()];
//                int[] ints = new int[state4.get(0).get(0).size()];
//                System.out.println(state4.toString());
//                for (int i = 0; i < state4.get(0).get(0).size(); i++) {
//                    System.out.println(state4.get(0).get(0).get(i));
//                    System.out.println(state4.get(0).get(0).size());
//                    System.out.println("ШТАТ = " + key);
//                    fillPolygon[i] = (int) ((-state4.get(0).get(0).get(i).get(1).doubleValue() + 74.9) * 10.8);
//                    ints[i] = (int) ((state4.get(0).get(0).get(i).get(0) + 180.0) * 10.8);
//                }
//                g.drawPolygon(ints, fillPolygon, ints.length);
            }
            else {
